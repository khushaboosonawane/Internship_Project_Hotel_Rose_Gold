...
$(function () {
    ...
    wind.on("scroll", function () {
        var bodyScroll = wind.scrollTop(),
            navbar = $(".navbar"),
            logo = $(".navbar .logo> upload_image");
        if (bodyScroll > 100) {
            navbar.addClass("nav-scroll");
            logo.attr('src', '/upload_image/website_logo/<%= hotel_data[0].hotel_logo %>');
        } else {
...
// Slider Grid Background owlCarousel *
    ...
    var btn1=document.getElementsByClassName("indic_btn")
    var slide_data=document.getElementById("slide_data")
    btn1[0].onclick=function(){
        slide_data.style.transform="translateX(0px)";
        for(i=0;i<4;i++){
            btn[i].classList.remove("active_1");
        }
        this.classList.add("active_1");
    }
    btn1[1].onclick=function(){
        slide_data.style.transform="translateX(-800px)";
        for(i=0;i<4;i++){
            btn[i].classList.remove("active_1");
        }
        this.classList.add("active_1");
    ...
    btn1[2].onclick=function(){
        slide_data.style.transform="translateX(-1600px)";
        for(i=0;i<4;i++){
            btn[i].classList.remove("active_1");
        }
        this.classList.add("active_1");
    ...
    btn1[3].onclick=function(){
        slide_data.style.transform="translateX(-2400px)";
        for(i=0;i<4;i++){
            btn[i].classList.remove("active_1");
        }
        this.classList.add("active_1");
